      ...
      <div className="p-4 border-t border-gray-200 dark:border-gray-700">
        ...
        >
          <div className="flex items-center gap-3">
            <div
              className={`w-8 h-8 rounded-lg flex items-center justify-center transition-all duration-300 ${dark ? "bg-indigo-600 text-white" : "bg-yellow-400 text-yellow-900"}`}
            >
              <FontAwesomeIcon
          ...
          {/* Toggle pill */}
          <div
            className={`relative w-11 h-6 rounded-full transition-all duration-300 ${dark ? "bg-indigo-600" : "bg-gray-300"}`}
          >
            <span
              className={`absolute top-0.5 left-0.5 w-5 h-5 rounded-full bg-white shadow-sm transition-all duration-300 ${dark ? "translate-x-5" : "translate-x-0"}`}
            />
          </div>
        </button>
      </div>
